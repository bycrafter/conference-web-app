...
async function handleLogin(): Promise<void> {
    ...
    loading.value = true;
    try {
        const requirePasswordChange = await authStore.login({ username: username.value, password: password.value });
            ...
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    ...
                    <div>
                        ...
                        <InputText id="username1" type="text" placeholder="Username" class="w-full md:w-[30rem] mb-8" v-model="username" @keyup.enter="handleLogin" />
